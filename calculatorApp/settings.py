...
SECRET_KEY = 'django-insecure-_o^9t)ty&a$8&@+=fh!g!g*trx6q%uw1f54-^3_&3$_91a)x_t'
...
TEMPLATES = [
    {
        ...
        # 'DIRS': [os.path.join(BASE_DIR, 'templates/myapp')],
        'DIRS': [os.path.join(BASE_DIR, 'templates/votingapp')],
        # 'DIRS': [os.path.join(BASE_DIR, 'templates/todoapp')],
